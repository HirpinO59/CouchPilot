...
enum L {
    ...
    private static let table: [String: [String: String]] = [
        ...
        "welcome.1.title": ["it": "Il tuo Mac, dal divano",
                            "en": "Your Mac, from the couch",
                            "es": "Tu Mac, desde el sofá",
                            "zh": "在沙发上操控你的 Mac"],
        "welcome.1.body": ["it": "Stick sinistro per muovere il cursore, A per cliccare. Tieni premuto A per trascinare, X è il tasto destro. Lo stick destro scorre le pagine.",
                           "en": "Left stick moves the cursor, A clicks. Hold A to drag, X is right click. The right stick scrolls.",
                           "es": "El stick izquierdo mueve el cursor, A hace clic. Mantén A para arrastrar, X es clic derecho. El stick derecho desplaza.",
                           "zh": "左摇杆移动光标，A 键点击。按住 A 可拖拽，X 键为右键。右摇杆用于滚动。"],
        "welcome.2.title": ["it": "Non solo il cursore",
                            "en": "More than a cursor",
                            "es": "Más que un cursor",
                            "zh": "不只是光标"],
        "welcome.2.body": ["it": "Y mette in pausa la musica, la croce direzionale regola il volume e cambia traccia, B apre Mission Control. Tieni R2 per il movimento di precisione, L2 per andare veloce.",
                           "en": "Y pauses playback, the D-pad handles volume and tracks, B opens Mission Control. Hold R2 for precision, L2 for speed.",
                           "es": "Y pausa la reproducción, la cruceta controla volumen y pistas, B abre Mission Control. Mantén R2 para precisión, L2 para velocidad.",
                           "zh": "Y 键暂停播放，方向键控制音量与曲目，B 键打开调度中心。按住 R2 精确移动，按住 L2 加速。"],
        "welcome.3.title": ["it": "Vive nella barra dei menu",
                            "en": "It lives in the menu bar",
                            "es": "Vive en la barra de menús",
                            "zh": "它住在菜单栏里"],
        "welcome.3.body": ["it": "Non c'è icona nel Dock: trovi tutto nell'icona del gamepad vicino all'orologio. Premi View e Menu insieme per spegnerla al volo, e nei giochi si mette in pausa da sola.",
                           "en": "There's no Dock icon: everything is under the controller icon near the clock. Press View and Menu together to switch it off, and it pauses itself in games.",
                           "es": "No hay icono en el Dock: todo está en el icono del mando junto al reloj. Pulsa View y Menu a la vez para desactivarla; en los juegos se pausa sola.",
                           "zh": "没有程序坞图标：一切都在时钟旁的手柄图标里。同时按 View 和 Menu 可随时关闭，在游戏中会自动暂停。"],
