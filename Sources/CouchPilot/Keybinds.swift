...
struct PadControl {
    ...
    static let all: [PadControl] = [
        ...
        PadControl(id: "LB", xboxName: "LB", psName: "L1",
                   ...
                   xbox: CGPoint(x: -0.37, y: 0.67), dualSense: CGPoint(x: -0.57, y: 0.93),
                   eightBitDo: CGPoint(x: -0.52, y: 0.93)),
        PadControl(id: "L3", xboxName: "L3", psName: "L3",
                   binding: .media(.mute), side: .left,
                   xbox: CGPoint(x: -0.44, y: 0.20), dualSense: CGPoint(x: -0.47, y: 0.16),
                   eightBitDo: CGPoint(x: -0.76, y: 0.70)),
        PadControl(id: "LStick", kind: .stickMove, xboxName: "pad.leftStick", psName: "pad.leftStick",
                   role: .cursor, side: .left,
                   xbox: CGPoint(x: -0.58, y: -0.01), dualSense: CGPoint(x: -0.47, y: -0.02),
                   eightBitDo: CGPoint(x: -0.76, y: 0.32)),
        PadControl(id: "DpadUp", xboxName: "▲", psName: "▲",
                   binding: .media(.soundUp), side: .left,
                   xbox: CGPoint(x: -0.24, y: -0.17), dualSense: CGPoint(x: -0.62, y: 0.60),
                   eightBitDo: CGPoint(x: -0.29, y: 0.20)),
        PadControl(id: "DpadLeft", xboxName: "◀", psName: "◀",
                   binding: .media(.previous), side: .left,
                   xbox: CGPoint(x: -0.37, y: -0.29), dualSense: CGPoint(x: -0.72, y: 0.46),
                   eightBitDo: CGPoint(x: -0.40, y: 0.04)),
        PadControl(id: "DpadRight", xboxName: "▶", psName: "▶",
                   binding: .media(.next), side: .left,
                   xbox: CGPoint(x: -0.11, y: -0.31), dualSense: CGPoint(x: -0.52, y: 0.46),
                   eightBitDo: CGPoint(x: -0.17, y: 0.04)),
        PadControl(id: "DpadDown", xboxName: "▼", psName: "▼",
                   binding: .media(.soundDown), side: .left,
                   xbox: CGPoint(x: -0.24, y: -0.44), dualSense: CGPoint(x: -0.62, y: 0.32),
                   eightBitDo: CGPoint(x: -0.28, y: -0.11)),
        // --- lato destro ---
        PadControl(id: "RB", xboxName: "RB", psName: "R1",
                   binding: .system(.spaceRight), side: .right,
                   xbox: CGPoint(x: 0.34, y: 0.67), dualSense: CGPoint(x: 0.57, y: 0.93),
                   eightBitDo: CGPoint(x: 0.52, y: 0.93)),
        PadControl(id: "Y", xboxName: "Y", psName: "△",
                   binding: .media(.play), side: .right,
                   xbox: CGPoint(x: 0.48, y: 0.32), dualSense: CGPoint(x: 0.62, y: 0.66),
                   eightBitDo: CGPoint(x: 0.58, y: 0.69)),
        PadControl(id: "B", xboxName: "B", psName: "◯",
                   binding: .system(.missionControl), side: .right,
                   xbox: CGPoint(x: 0.62, y: 0.12), dualSense: CGPoint(x: 0.76, y: 0.48),
                   eightBitDo: CGPoint(x: 0.73, y: 0.51)),
        PadControl(id: "X", xboxName: "X", psName: "▢",
                   binding: .mouse(.right), side: .right,
                   xbox: CGPoint(x: 0.34, y: 0.11), dualSense: CGPoint(x: 0.47, y: 0.44),
                   eightBitDo: CGPoint(x: 0.44, y: 0.47)),
        PadControl(id: "A", xboxName: "A", psName: "✕",
                   binding: .mouse(.left), side: .right,
                   xbox: CGPoint(x: 0.48, y: -0.10), dualSense: CGPoint(x: 0.62, y: 0.25),
                   eightBitDo: CGPoint(x: 0.59, y: 0.29)),
        PadControl(id: "R3", xboxName: "R3", psName: "R3",
                   binding: .mouse(.middle), side: .right,
                   xbox: CGPoint(x: 0.31, y: -0.19), dualSense: CGPoint(x: 0.47, y: 0.16),
                   eightBitDo: CGPoint(x: 0.51, y: 0.18)),
        PadControl(id: "RStick", kind: .stickMove, xboxName: "pad.rightStick", psName: "pad.rightStick",
                   role: .scroll, side: .right,
                   xbox: CGPoint(x: 0.17, y: -0.42), dualSense: CGPoint(x: 0.47, y: -0.02),
                   eightBitDo: CGPoint(x: 0.45, y: -0.20)),
        ...
        PadControl(id: "View", xboxName: "View", psName: "Create", altName: "−",
                   ...
                   xbox: CGPoint(x: -0.14, y: 0.14), dualSense: CGPoint(x: -0.47, y: 0.77),
                   eightBitDo: CGPoint(x: -0.27, y: 0.73)),
    ]
